...
| Should Boiler Room's bottom circuit hug the station edge? | The playable loop and the station infrastructure baked into the board art occupy nearly the same band, so they read as two railways in one space. | Reported in the 2026-09-09 readability review. Fixing it means either moving that authored circuit up a row or separating the station strip in the board art; both are design/art calls. |
