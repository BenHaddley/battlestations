...
const PROFILES: Array[Dictionary] = [
	...
	{"id":"baby", "name":"Baby Spider", "unlock_level":1, "weight":5, "hp":3, "speed":1.45, "bounty":35, "scale":0.070, "ability":"", "walk_a":preload("res://assets/sprites/spiders/Baby 1.png"), "walk_b":preload("res://assets/sprites/spiders/Baby 2.png"), "death":preload("res://assets/sprites/spiders/Baby Die.png")},
