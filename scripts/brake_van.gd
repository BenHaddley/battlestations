...
## these is coupled — and grants every other car in that train a 25%
## damage boost. Doesn't count toward the train's weight. Per its
## infowiki card's third paragraph, also trims accel/coast time by 15%.

@export var weight: float = 0.0
@export var attack_damage_bonus: float = 1.25
